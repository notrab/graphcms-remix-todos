...
export type CreateAuthUserMutation = {
  __typename?: "Mutation";
  user?:
    | { __typename?: "AuthUser"; id: string; name: string; email: string }
    | null
    | undefined;
};

export type GetAuthUserByEmailQueryVariables = Exact<{
  email: Scalars["String"];
}>;

export type GetAuthUserByEmailQuery = {
  __typename?: "Query";
  user?:
    | { __typename?: "AuthUser"; id: string; email: string; password: string }
    | null
    | undefined;
};

export type GetAuthUserByIdQueryVariables = Exact<{
  id: Scalars["ID"];
}>;

export type GetAuthUserByIdQuery = {
  __typename?: "Query";
  user?:
    | { __typename?: "AuthUser"; id: string; name: string; email: string }
    | null
...
`;
export const GetAuthUserByEmailDocument = gql`
...
`;
export const GetAuthUserByIdDocument = gql`
  query GetAuthUserById($id: ID!) {
    user: authUser(where: { id: $id }) {
      id
      name
      email
    }
...
export function getSdk(
  ...
  return {
    CreateAuthUser(
      variables: CreateAuthUserMutationVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<CreateAuthUserMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreateAuthUserMutation>(
    ...
    GetAuthUserByEmail(
      variables: GetAuthUserByEmailQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<GetAuthUserByEmailQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetAuthUserByEmailQuery>(
            GetAuthUserByEmailDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "GetAuthUserByEmail"
    ...
    GetAuthUserById(
      variables: GetAuthUserByIdQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<GetAuthUserByIdQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetAuthUserByIdQuery>(
...
export type PossibleTypesResultData = {
  possibleTypes: {
    ...
    ScheduledOperationAffectedDocument: ["Asset", "AuthUser"];
  };
};
